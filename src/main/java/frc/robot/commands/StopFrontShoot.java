...
public class StopFrontShoot extends CommandBase {
  private final FrontShooter m_FrontShooter;
  /** Creates a new StopFrontShoot. */
  public StopFrontShoot(FrontShooter frontShooter) {
  ...
  @Override
  public void execute() {
    m_FrontShooter.stopFrontShooter();
  }
